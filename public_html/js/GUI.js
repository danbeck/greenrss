...
Gui.prototype.openConfigurePage = function(openConfigButton) {
	...
	backButton.onclick = function() {
		...
		if (useTheOldReader)
			returnValue.useTheOldReader = useTheOldReader;

		if (theoldreaderUsername && theoldreaderUsername !== "")
			returnValue.theoldreaderUsername = theoldreaderUsername;

		if (theoldreaderPassword && theoldreaderPassword !== "")
			returnValue.theoldreaderPassword = theoldreaderPassword;
